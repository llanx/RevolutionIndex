...
class NormMethod(Enum):
    ...
    FULL_HISTORY_PERCENTILE = "full_history_percentile"
...
#
# NormMethod classification:
#   ROLLING_ZSCORE: cyclical/mean-reverting variables (#6, #9, #10, #14, #16, #17, #18, #26, #27, #40)
#   FULL_HISTORY_PERCENTILE: structural/secular-trend variables (all others)
# ---------------------------------------------------------------------------
...
VARIABLES: list[Variable] = [
    ...
    Variable(
        ...
        norm_method=NormMethod.FULL_HISTORY_PERCENTILE,
        frequency="annual",
        coverage_start=1963,
        short_series=False,
    ...
    Variable(
        ...
        evidence_rating=EvidenceRating.STRONG,
        norm_direction=NormDirection.HIGHER_IS_WORSE,
        norm_method=NormMethod.ROLLING_ZSCORE,
        frequency="weekly",
        coverage_start=1993,
        short_series=False,
        construction_recipe=None,
