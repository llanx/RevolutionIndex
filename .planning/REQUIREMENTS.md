...
- [x] **MOD-04**: Implement ensemble/composite scoring if multiple models are used
- [x] **MOD-05**: Implement score interpretation labels mapping 0-100 to severity tiers
